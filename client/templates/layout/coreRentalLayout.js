...
Template.coreRentalLayout.onCreated(() => {
...
Template.coreRentalLayout.onRendered(function () {
  $("body").addClass("admin");
});

Template.coreRentalLayout.onDestroyed(() => {
  $("body").removeClass("admin");
});

Template.coreRentalLayout.helpers({
  control: function () {
...
Template.coreRentalLayout.events({
